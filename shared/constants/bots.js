...
export const REPLY_TEMPLATES = {
  agree: [
    'Same here. {city} market is rough right now',
    'Yeah I noticed that too. Hit us hard this week',
    'Facts. Seeing the exact same thing on my end',
    '100%. Tell me about it',
    'Right?? Thought it was just me',
    "Couldn't agree more. It's been brutal",
    'Same boat. Hoping it turns around soon',
    'Yep. Day {day} and still dealing with this',
  ],
  disagree: [
    "Idk, I'm actually seeing the opposite in {city}",
    "Really? That hasn't been my experience at all",
    "Different story here — been my best week actually",
    'Hmm not sure about that. Working fine for me',
    "Might be a {city} thing? We're doing alright",
    "Counterpoint: it's been solid over here",
  ],
  helpful: [
    'Try raising your prices 10-15%. Margins > volume',
    'Check wholesale right now — prices dropped',
    'More techs = more installs = more revenue. Hire up',
    'Auto-pricing saved me hours. Worth trying',
    'Focus on one city and dominate it first',
    'Loans are cheap right now. Good time to expand',
    'Stock winter tires NOW before the spike',
    'High-traffic cities > low-rent cities every time',
    "Service revenue adds up fast. Don't ignore it",
    'Get rep to 30 and wholesale changes everything',
    'Keep at least 2 months expenses in the bank. Trust me',
    'Hire a manager when you hit 3 shops. The efficiency boost is real',
  ],
  congratulate: [
    "Nice work! That's legit impressive",
    'Congrats! Keep grinding',
    'Solid. Respect the hustle',
    'Damn, how long did that take you?',
    'Love to see it. {company} taking notes over here',
    "That's the goal right there. Well done",
    'Big moves. Inspired fr',
    'W. Massive W.',
  ],
  competitive: [
    'Watch your back though. {company} is coming',
    'Enjoy it while it lasts',
    'Not bad. Check the leaderboard next week tho',
    "We'll see who's on top by month end",
    "Solid numbers but I'm not worried lol",
    'Good for you. Now try doing it in {city}',
    '{company} did that last week',
  ],
  question_response: [
    'I run {shopCount} shops and it works. Start small',
    'Go all-in on inventory. Cash sitting idle is wasted',
    'I waited until rep 40 and it was worth it honestly',
    'In {city} I price 5-10% above average. Still sells',
    'Aggressive expansion early, optimize later',
    'Took a loan day 1. No regrets',
    'At least 20 tires per type per location minimum',
    'Auto-price the commodity stuff, manual for premium',
    'Depends on your cash position honestly',
    "What's your rep at? The answer changes a lot based on that",
  ],
  about_pricing: [
    'Pricing is everything in this game honestly',
    'I dropped prices 5% last week and volume doubled',
    'Premium pricing works if your loyalty is high enough',
    "The sweet spot is right at market rate. Don't overthink it",
    'Check what others are charging in {city} first',
  ],
  about_tires: [
    'All-season is the bread and butter. Never run out',
    'Winter tires print money November through March',
    'Performance tires = high margin but slow movers',
    "Don't sleep on commercial. Fleet deals are huge",
    "I stock heavy on whatever's in season",
  ],
  about_money: [
    "Cash flow is king. Revenue means nothing if you can't pay rent",
    'I keep a 60-day runway at all times. Learned the hard way',
    'Take the loan. Seriously. Growth > saving',
    'Bank deposits earn decent interest. Park your excess there',
    'The money gets real once you hit wholesale',
  ],
  about_expansion: [
    "Don't expand until your first shop is profitable. Seriously",
    'Second shop should be in a different city. Diversify',
    'I waited too long to expand and got left behind',
    'Quality over quantity. 3 great shops beats 6 mediocre ones',
    "Franchise is the move once you're ready",
  ],
  about_factory: [
    'Factory is a money pit at first but it pays off huge',
    'My branded tires outsell everything now',
    'R&D is worth every penny. Quality compounds',
    "Don't build a factory unless you have the cash runway for it",
    'Factory + wholesale = vertical integration = game over',
  ],
};

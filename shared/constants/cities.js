export const CITIES = [
  ...
  { id: "huntington_wv", name: "Huntington", state: "WV", pop: 46, size: "city", lat: 38.419, lng: -82.445, mx: 4, dem: 32, cost: .55, win: 1.0 },
  { id: "nyc_ny", name: "New York City", state: "NY", pop: 8300, size: "mega", lat: 40.712, lng: -74.006, mx: 35, dem: 700, cost: 1.9, win: 1.0 },
  ...
  { id: "houston_tx", name: "Houston", state: "TX", pop: 2300, size: "mega", lat: 29.760, lng: -95.369, mx: 30, dem: 600, cost: 1.85, win: .1 },
  { id: "dallas_tx", name: "Dallas", state: "TX", pop: 1340, size: "mega", lat: 32.776, lng: -96.796, mx: 28, dem: 500, cost: 1.8, win: .15 },
  { id: "sanantonio_tx", name: "San Antonio", state: "TX", pop: 1434, size: "mega", lat: 29.424, lng: -98.493, mx: 22, dem: 380, cost: 1.8, win: .1 },
  ...
  { id: "mcallen_tx", name: "McAllen", state: "TX", pop: 143, size: "city", lat: 26.203, lng: -98.230, mx: 6, dem: 55, cost: .55, win: .05 },
  { id: "la_ca", name: "Los Angeles", state: "CA", pop: 3900, size: "mega", lat: 34.052, lng: -118.243, mx: 35, dem: 700, cost: 1.85, win: .1 },
  { id: "sf_ca", name: "San Francisco", state: "CA", pop: 870, size: "metro", lat: 37.774, lng: -122.419, mx: 14, dem: 200, cost: 1.8, win: .15 },
  { id: "sandiego_ca", name: "San Diego", state: "CA", pop: 1386, size: "mega", lat: 32.715, lng: -117.161, mx: 20, dem: 330, cost: 1.85, win: .1 },
  ...
  { id: "flint_mi", name: "Flint", state: "MI", pop: 97, size: "city", lat: 43.012, lng: -83.687, mx: 6, dem: 50, cost: .55, win: 1.5 },
  ...
  { id: "chicago_il", name: "Chicago", state: "IL", pop: 2700, size: "mega", lat: 41.878, lng: -87.629, mx: 30, dem: 580, cost: 1.8, win: 1.35 },
  ...
  { id: "phoenix_az", name: "Phoenix", state: "AZ", pop: 1608, size: "mega", lat: 33.448, lng: -112.074, mx: 25, dem: 420, cost: 1.85, win: .05 },
  ...
  { id: "jackson_ms", name: "Jackson", state: "MS", pop: 153, size: "city", lat: 32.298, lng: -90.184, mx: 7, dem: 60, cost: .55, win: .2 },
  { id: "biloxi_ms", name: "Biloxi", state: "MS", pop: 46, size: "small", lat: 30.396, lng: -88.885, mx: 3, dem: 25, cost: .50, win: .1 },
  ...
  { id: "indiana_pa", name: "Indiana", state: "PA", pop: 13, size: "rural", lat: 40.621, lng: -79.152, mx: 2, dem: 18, cost: .55, win: 1.3, agPct: .45 },
  { id: "somerset_pa", name: "Somerset", state: "PA", pop: 6, size: "rural", lat: 40.008, lng: -79.077, mx: 2, dem: 12, cost: .50, win: 1.4, agPct: .6 },
  { id: "lancaster_pa", name: "Lancaster", state: "PA", pop: 60, size: "city", lat: 40.037, lng: -76.305, mx: 6, dem: 70, cost: .95, win: 1.1, agPct: .35 },
  { id: "wooster_oh", name: "Wooster", state: "OH", pop: 27, size: "rural", lat: 40.805, lng: -81.935, mx: 2, dem: 20, cost: .52, win: 1.2, agPct: .55 },
  { id: "mansfield_oh", name: "Mansfield", state: "OH", pop: 46, size: "small", lat: 40.758, lng: -82.515, mx: 3, dem: 30, cost: .85, win: 1.2, agPct: .3 },
  { id: "elkins_wv", name: "Elkins", state: "WV", pop: 7, size: "rural", lat: 38.926, lng: -79.846, mx: 2, dem: 10, cost: .50, win: 1.0, agPct: .65 },
  { id: "tifton_ga", name: "Tifton", state: "GA", pop: 17, size: "rural", lat: 31.450, lng: -83.508, mx: 2, dem: 15, cost: .50, win: .15, agPct: .7 },
  ...
  { id: "traverse_mi", name: "Traverse City", state: "MI", pop: 15, size: "rural", lat: 44.763, lng: -85.620, mx: 2, dem: 14, cost: .55, win: 1.5, agPct: .4 },
  { id: "kinston_nc", name: "Kinston", state: "NC", pop: 20, size: "rural", lat: 35.262, lng: -77.581, mx: 2, dem: 16, cost: .52, win: .3, agPct: .5 },
  ...
  { id: "toppenish_wa", name: "Toppenish", state: "WA", pop: 9, size: "rural", lat: 46.377, lng: -120.310, mx: 2, dem: 10, cost: .50, win: 1.2, agPct: .7 },
  { id: "valdosta_ga", name: "Valdosta", state: "GA", pop: 56, size: "small", lat: 30.832, lng: -83.278, mx: 3, dem: 22, cost: .52, win: .15, agPct: .5 },
  { id: "jonesboro_ar", name: "Jonesboro", state: "AR", pop: 78, size: "city", lat: 35.842, lng: -90.704, mx: 3, dem: 25, cost: .55, win: .5, agPct: .45 },
  { id: "garden_ks", name: "Garden City", state: "KS", pop: 28, size: "rural", lat: 37.971, lng: -100.872, mx: 2, dem: 12, cost: .50, win: .7, agPct: .65 },
  { id: "scottsbluff_ne", name: "Scottsbluff", state: "NE", pop: 15, size: "rural", lat: 41.866, lng: -103.667, mx: 2, dem: 10, cost: .50, win: 1.1, agPct: .6 },
  ...
  // ── New Small Towns (rural, pop 3-70, dem 8-28, cost 0.50-0.60) ──
  { id: "meadville_pa", name: "Meadville", state: "PA", pop: 13, size: "rural", lat: 41.641, lng: -80.151, mx: 2, dem: 14, cost: .52, win: 1.3, agPct: .4 },
  { id: "wellsboro_pa", name: "Wellsboro", state: "PA", pop: 3, size: "rural", lat: 41.748, lng: -77.300, mx: 1, dem: 8, cost: .50, win: 1.3, agPct: .55 },
  { id: "waynesburg_pa", name: "Waynesburg", state: "PA", pop: 4, size: "rural", lat: 39.896, lng: -80.178, mx: 1, dem: 10, cost: .50, win: 1.3, agPct: .6 },
  { id: "lisbon_oh", name: "Lisbon", state: "OH", pop: 3, size: "rural", lat: 40.772, lng: -80.767, mx: 1, dem: 8, cost: .50, win: 1.2, agPct: .55 },
  { id: "newcomerstown_oh", name: "Newcomerstown", state: "OH", pop: 4, size: "rural", lat: 40.272, lng: -81.605, mx: 1, dem: 9, cost: .50, win: 1.2, agPct: .5 },
  { id: "cambridge_oh", name: "Cambridge", state: "OH", pop: 10, size: "rural", lat: 40.031, lng: -81.588, mx: 2, dem: 12, cost: .52, win: 1.2, agPct: .45 },
  { id: "pointpleasant_wv", name: "Point Pleasant", state: "WV", pop: 4, size: "rural", lat: 38.844, lng: -82.137, mx: 1, dem: 9, cost: .50, win: 1.0, agPct: .6 },
  { id: "buckhannon_wv", name: "Buckhannon", state: "WV", pop: 6, size: "rural", lat: 38.993, lng: -80.232, mx: 1, dem: 10, cost: .50, win: 1.0, agPct: .55 },
  { id: "cordele_ga", name: "Cordele", state: "GA", pop: 11, size: "rural", lat: 31.963, lng: -83.776, mx: 2, dem: 12, cost: .50, win: .15, agPct: .7 },
  { id: "bainbridge_ga", name: "Bainbridge", state: "GA", pop: 12, size: "rural", lat: 30.903, lng: -84.575, mx: 2, dem: 13, cost: .50, win: .15, agPct: .65 },
  { id: "eufaula_al", name: "Eufaula", state: "AL", pop: 12, size: "rural", lat: 31.891, lng: -85.145, mx: 2, dem: 12, cost: .50, win: .2, agPct: .6 },
  { id: "scottsboro_al", name: "Scottsboro", state: "AL", pop: 15, size: "rural", lat: 34.672, lng: -86.034, mx: 2, dem: 14, cost: .52, win: .3, agPct: .5 },
  { id: "deming_nm", name: "Deming", state: "NM", pop: 14, size: "rural", lat: 32.268, lng: -107.758, mx: 2, dem: 12, cost: .50, win: .2, agPct: .55 },
  { id: "ruidoso_nm", name: "Ruidoso", state: "NM", pop: 8, size: "rural", lat: 33.331, lng: -105.673, mx: 1, dem: 10, cost: .52, win: .5, agPct: .4 },
  { id: "salmon_id", name: "Salmon", state: "ID", pop: 3, size: "rural", lat: 45.175, lng: -113.895, mx: 1, dem: 8, cost: .50, win: 1.2, agPct: .6 },
  { id: "burley_id", name: "Burley", state: "ID", pop: 11, size: "rural", lat: 42.535, lng: -113.792, mx: 2, dem: 12, cost: .50, win: 1.2, agPct: .65 },
  { id: "shelbyville_ky", name: "Shelbyville", state: "KY", pop: 16, size: "rural", lat: 38.212, lng: -85.223, mx: 2, dem: 15, cost: .52, win: .8, agPct: .5 },
  { id: "danville_ky", name: "Danville", state: "KY", pop: 17, size: "rural", lat: 37.645, lng: -84.772, mx: 2, dem: 16, cost: .52, win: .8, agPct: .45 },
  { id: "grinnell_ia", name: "Grinnell", state: "IA", pop: 9, size: "rural", lat: 41.743, lng: -92.722, mx: 1, dem: 10, cost: .50, win: 1.2, agPct: .7 },
  { id: "independence_ia", name: "Independence", state: "IA", pop: 6, size: "rural", lat: 42.468, lng: -91.889, mx: 1, dem: 9, cost: .50, win: 1.2, agPct: .65 },
  { id: "emporia_ks", name: "Emporia", state: "KS", pop: 24, size: "rural", lat: 38.403, lng: -96.181, mx: 2, dem: 18, cost: .52, win: .8, agPct: .55 },
  { id: "arcadia_fl", name: "Arcadia", state: "FL", pop: 8, size: "rural", lat: 27.219, lng: -81.858, mx: 1, dem: 10, cost: .50, win: .05, agPct: .6 },
  { id: "mount_airy_nc", name: "Mount Airy", state: "NC", pop: 10, size: "rural", lat: 36.499, lng: -80.606, mx: 2, dem: 12, cost: .50, win: .3, agPct: .5 },
  // ── New Mid-Size Cities (city, pop 58-320, dem 45-100, cost 0.88-1.15) ──
  { id: "olympia_wa", name: "Olympia", state: "WA", pop: 55, size: "city", lat: 47.037, lng: -122.900, mx: 5, dem: 48, cost: .95, win: 1.2 },
  { id: "henderson_nv", name: "Henderson", state: "NV", pop: 320, size: "city", lat: 36.039, lng: -114.981, mx: 10, dem: 95, cost: 1.0, win: .05 },
  { id: "boulder_co", name: "Boulder", state: "CO", pop: 105, size: "city", lat: 40.014, lng: -105.270, mx: 6, dem: 55, cost: 1.15, win: 1.1 },
  { id: "bakercity_ca", name: "Visalia", state: "CA", pop: 141, size: "city", lat: 36.330, lng: -119.292, mx: 6, dem: 50, cost: .95, win: .1, agPct: .4 },
  { id: "owensboro_ky", name: "Owensboro", state: "KY", pop: 60, size: "city", lat: 37.774, lng: -87.111, mx: 4, dem: 45, cost: .88, win: .8, agPct: .3 },
  { id: "joplin_mo", name: "Joplin", state: "MO", pop: 51, size: "city", lat: 37.084, lng: -94.513, mx: 4, dem: 45, cost: .88, win: .9 },
  { id: "waterloo_ia", name: "Waterloo", state: "IA", pop: 68, size: "city", lat: 42.492, lng: -92.342, mx: 5, dem: 48, cost: .88, win: 1.2, agPct: .35 },
  { id: "salina_ks", name: "Salina", state: "KS", pop: 47, size: "city", lat: 38.840, lng: -97.611, mx: 4, dem: 38, cost: .88, win: .8, agPct: .5 },
